  ...
  <div class="panel-body">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
          {!! Breadcrumb::withLinks(['Dashboard'=>'/dashboard','Status Tinggal'=>'/status/tinggal','Tambah']) !!}
            <h1>Tambah <small>Status Tinggal</small></h1>
            <br>
            {!! Form::open(array('url'=>'status/tinggal')) !!}
