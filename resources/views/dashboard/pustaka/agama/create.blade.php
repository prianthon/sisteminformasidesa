  ...
  <div class="panel-body">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
          {!! Breadcrumb::withLinks(['Dashboard'=>'/dashboard','Agama'=>'/agama','Tambah']) !!}
            <h1>Tambah <small>Agama</small></h1>
            <br>
            {!! Form::open(array('url'=>'agama')) !!}
            {!! link_to('agama','Kelola Agama',['class'=>'btn btn-primary']) !!} {!! Form::submit('Simpan',['class'=>'btn btn-success']) !!}
            <br><br>
            {!! Html::ul($errors->all()) !!}
            <div class="form-group">
                <div class="controls">
                    @include('dashboard.pustaka.agama.form')
                </div>
            </div>
            {!! Form::close() !!}
        </div>
