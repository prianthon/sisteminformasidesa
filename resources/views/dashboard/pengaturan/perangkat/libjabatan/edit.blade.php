              ...
              <div class="tab-content">
                <div class="tab-pane fade active in" id="tab2_1">
                  <div class="row"><br/>
                    <br>
                    <div class="col-md-8">
                    {!! Form::model($libjabatan, array('url'=>'pengaturan/umum/perangkatjabatan/'.$libjabatan->id,'method'=>'patch')) !!}
                    {!! link_to('/pengaturan/umum/perangkatjabatan','Kelola Lib Jabatan Perangkat',['class'=>'btn btn-primary']) !!} {!! Form::submit('Simpan',['class'=>'btn btn-success']) !!}
                    <br><br>
                    {!! Html::ul($errors->all()) !!}
                    <div class="form-group">
                        <div class="controls">
                            @include('dashboard.pengaturan.perangkat.libjabatan.form')
                        </div>
                    </div>
                    {!! Form::close() !!}
                    </div>
