              ...
              <div class="tab-content">
                <div class="tab-pane fade active in" id="tab2_1">
                  <div class="row"><br/>
                    <br>
                    <div class="col-md-12">
                    {!! Form::open(array('url'=>'/pengaturan/umum/perangkatdesa')) !!}
                    {!! link_to('/pengaturan/umum/perangkatdesa','Kelola Perangkat Desa',['class'=>'btn btn-primary']) !!} {!! Form::submit('Simpan',['class'=>'btn btn-success']) !!}
                    <br><br>
                    {!! Html::ul($errors->all()) !!}
                    <div class="form-group">
                        <div class="controls">
                            @include('dashboard.pengaturan.perangkat.desa.form')
                        </div>
                    </div>
                    {!! Form::close() !!}
                    </div>
