              ...
              <div class="tab-content">
                <div class="tab-pane fade active in" id="tab2_1">
                  <div class="row"><br/>
                    <br>
                    <div class="col-md-8">
                    {!! Form::model($librt, array('url'=>'pengaturan/umum/librt/'.$librt->id,'method'=>'patch')) !!}
                    {!! link_to('/pengaturan/umum/librt','Ubah Lib RT',['class'=>'btn btn-primary']) !!} {!! Form::submit('Simpan',['class'=>'btn btn-success']) !!}
                    <br><br>
                    {!! Html::ul($errors->all()) !!}
                    <div class="form-group">
                        <div class="controls">
                            @include('dashboard.pengaturan.wilayah.librt.form')
                        </div>
                    </div>
                    {!! Form::close() !!}
                    </div>
