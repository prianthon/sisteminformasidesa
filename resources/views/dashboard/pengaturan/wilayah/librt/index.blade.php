            ...
            <ul id="myTab2" class="nav nav-tabs nav-dark">
              ...
              <div class="tab-content">
                <div class="tab-pane fade active in" id="tab2_1">
                  <div class="row"><br/>
                    {!! link_to('pengaturan/umum/librt/create','Tambah Lib RT',['class'=>'btn btn-primary']) !!}
                    <hr>
                    {!! Form::open(array('url'=>'pengaturan/umum/librt/cari')) !!}
                    {!! Form::text('keyword',null,['class'=>'form-control','placeholder'=>'Cari Lib RT, ketik lalu tekan enter']) !!}
                    {!! Form::close() !!}
                    <hr>
                      ...
                      <tbody class="no-bd-y">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            {!! link_to('pengaturan/umum/librt/'.$lt->id.'/edit','Ubah',['class'=>'btn btn-warning btn-sm']) !!}{!! Form::submit('Hapus',['class'=>'btn btn-danger btn-sm']) !!}
                            {!! Form::close() !!}
                          </td>
                        </tr>
                        @endforeach
