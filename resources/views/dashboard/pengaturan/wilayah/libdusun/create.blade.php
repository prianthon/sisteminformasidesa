              ...
              <div class="tab-content">
                <div class="tab-pane fade active in" id="tab2_1">
                  <div class="row"><br/>
                    <br>
                    <div class="col-md-8">
                    {!! Form::open(array('url'=>'/pengaturan/umum/libdusun')) !!}
                    {!! link_to('/pengaturan/umum/libdusun','Kelola Lib Dusun',['class'=>'btn btn-primary']) !!} {!! Form::submit('Simpan',['class'=>'btn btn-success']) !!}
                    <br><br>
                    {!! Html::ul($errors->all()) !!}
