            ...
            <ul id="myTab2" class="nav nav-tabs nav-dark">
              ...
              <div class="tab-content">
                <div class="tab-pane fade active in" id="tab2_1">
                  <div class="row"><br/>
                    {!! link_to('pengaturan/umum/libdusun/create','Tambah Lib Dusun',['class'=>'btn btn-primary']) !!}
                    <hr>
                    {!! Form::open(array('url'=>'pengaturan/umum/libdusun/cari')) !!}
                    {!! Form::text('keyword',null,['class'=>'form-control','placeholder'=>'Cari Lib Dusun, ketik lalu tekan enter']) !!}
                    {!! Form::close() !!}
                    <hr>
