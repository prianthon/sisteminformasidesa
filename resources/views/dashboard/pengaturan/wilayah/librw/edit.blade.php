              ...
              <div class="tab-content">
                <div class="tab-pane fade active in" id="tab2_1">
                  <div class="row"><br/>
                    <br>
                    <div class="col-md-8">
                    {!! Form::model($librw, array('url'=>'pengaturan/umum/librw/'.$librw->id,'method'=>'patch')) !!}
                    {!! link_to('/pengaturan/umum/librw','Ubah Lib RW',['class'=>'btn btn-primary']) !!} {!! Form::submit('Simpan',['class'=>'btn btn-success']) !!}
                    <br><br>
                    {!! Html::ul($errors->all()) !!}
                    <div class="form-group">
                        <div class="controls">
                            @include('dashboard.pengaturan.wilayah.librw.form')
                        </div>
                    </div>
                    {!! Form::close() !!}
                    </div>
