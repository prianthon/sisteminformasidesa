...
<div id="main-content">
  <div class="panel-body">
    <div class="row">
      <div class="col-md-12">
        {!! Breadcrumb::withLinks(['Dashboard'=>'/dashboard','Pengaturan Umum'=>'/pengaturan/umum','Kelola Lib Provinsi'=>'/pengaturan/umum/libprovinsi','Ubah'=>'/pengaturan/umum/libprovinsi/create','Lib Provinsi']) !!}
        <h1>Ubah<small> Lib Provinsi</small></h1><br/>
          <div class="">
